/**
 * TYPE-SPECIFIC FIELD DEFINITIONS (Extension Version)
 * 
 * This file defines which fields appear for each incident type.
 * Keep in sync with src/lib/type-field-definitions.ts
 * 
 ...
 */
function getSectionsForTypes(selectedTypes) {
 ...
 */
function getFieldKeysForTypes(selectedTypes) {
 ...
 */
function shouldShowSection(sectionTitle, selectedTypes) {
 ...
 */
function getFieldDefinitionByKey(key) {
...
if (typeof window !== 'undefined') {
  window.TypeFieldDefinitions = {
    ...
    FORCE_TYPE_OPTIONS,
    getSectionsForTypes,
    getFieldKeysForTypes,
    shouldShowSection,
    getFieldDefinitionByKey
  };
}
