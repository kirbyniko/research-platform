...
const STATEMENT_TYPE_OPTIONS = [
  ...
  { value: 'medical_testimony', label: 'Medical Testimony' },
  { value: 'religious_moral', label: 'Religious/Moral Statement' },
  { value: 'whistleblower', label: 'Whistleblower Account' },
  { value: 'victim_account', label: 'Victim Account' },
  { value: 'family_account', label: 'Family Account' },
...
const STATEMENT_SECTIONS = [
  ...
  {
    title: 'Impact & Reach',
    types: ['denunciation', 'support', 'legal_analysis', 'religious_moral'],
    fields: [
      ...
      { key: 'engagement_likes', label: 'Likes/Hearts', type: 'number', placeholder: 'Social media engagement' },
      { key: 'engagement_shares', label: 'Shares/Retweets', type: 'number' },
      { key: 'engagement_views', label: 'Views', type: 'number' },
    ],
  },
  {
    title: 'Persuasion Context',
    types: ['denunciation'],
    fields: [
      { key: 'previously_supported', label: 'Previously Supported ICE/Enforcement', type: 'checkbox', verifiable: true },
      { key: 'party_typically_supports', label: 'Party Typically Supports Enforcement', type: 'checkbox' },
      { key: 'breaking_ranks', label: 'Breaking Ranks (Going Against Party/Base)', type: 'checkbox' },
    ],
  },
  {
    title: 'Responses',
    types: ['denunciation', 'whistleblower', 'victim_account', 'family_account', 'witness_account'],
    fields: [
      { key: 'ice_response', label: 'ICE/Official Response', type: 'textarea', quotable: true, verifiable: true },
      { key: 'notable_responses', label: 'Other Notable Responses', type: 'textarea', quotable: true },
    ],
  },
  {
    title: 'Whistleblower Details',
    types: ['whistleblower'],
    fields: [
      { key: 'former_position', label: 'Former Position', type: 'text', quotable: true, verifiable: true },
      { key: 'employment_dates', label: 'Employment Period', type: 'text', placeholder: 'e.g., 2018-2023' },
      { key: 'facility_location', label: 'Facility/Location', type: 'text', quotable: true, verifiable: true },
      { key: 'patterns_described', label: 'Patterns Described', type: 'textarea', quotable: true, verifiable: true },
      { key: 'corroborating_evidence', label: 'Corroborating Evidence', type: 'textarea', quotable: true },
    ],
  },
  {
    title: 'Firsthand Account Details',
    types: ['victim_account', 'family_account', 'witness_account'],
    fields: [
      { key: 'incident_date', label: 'Date of Incident', type: 'date', verifiable: true },
      { key: 'incident_location', label: 'Location', type: 'text', quotable: true, verifiable: true },
      { key: 'relationship_to_victim', label: 'Relationship to Victim', type: 'text', placeholder: 'e.g., mother, neighbor' },
      { key: 'account_description', label: 'Description of Events', type: 'textarea', quotable: true, verifiable: true },
      { key: 'related_incident_id', label: 'Related Incident ID', type: 'text', placeholder: 'Link to documented incident' },
    ],
  },
  {
    title: 'Legal Analysis Details',
    types: ['legal_analysis'],
    fields: [
      { key: 'legal_issue', label: 'Legal Issue Addressed', type: 'text', quotable: true, verifiable: true },
      { key: 'constitutional_basis', label: 'Constitutional Basis', type: 'text', placeholder: 'e.g., 4th Amendment, Due Process', quotable: true },
      { key: 'relevant_cases', label: 'Relevant Case Law', type: 'textarea', placeholder: 'Cases cited in analysis', quotable: true, verifiable: true },
      { key: 'legal_conclusion', label: 'Legal Conclusion', type: 'textarea', quotable: true, verifiable: true },
    ],
  },
  {
    title: 'Medical Details',
    types: ['medical_testimony'],
    fields: [
      { key: 'medical_specialty', label: 'Medical Specialty', type: 'text', placeholder: 'e.g., Emergency Medicine, Psychiatry' },
      { key: 'conditions_observed', label: 'Conditions Observed', type: 'textarea', quotable: true, verifiable: true },
      { key: 'standard_of_care', label: 'Standard of Care Issues', type: 'textarea', quotable: true, verifiable: true },
      { key: 'health_outcomes', label: 'Health Outcomes Described', type: 'textarea', quotable: true, verifiable: true },
    ],
  },
];
