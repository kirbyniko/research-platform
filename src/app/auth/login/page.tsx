  ...
  return (
    <div className="w-full max-w-md">
      ...
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 px-4 py-3 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 text-center">
        ...
        <Link 
          href="/submit" 
          className="inline-block border border-gray-300 px-4 py-2 text-sm hover:bg-gray-50"
        >
          Submit as Guest
        </Link>
      </div>
