// Create test cases for all incident types to verify form symmetry
// Run with: node scripts/create-test-cases.js
...
const testCases = [
  ...
  },
  {
    ...
    injury_type: 'Broken wrist, taser burns',
    injury_severity: 'moderate',
    injury_weapon: 'Taser, baton',
    injury_cause: 'During arrest'
  },
  {
    ...
    subject_age: 25,
    subject_gender: 'female',
    subject_nationality: 'Cuba',
    subject_immigration_status: 'asylum_seeker',
    summary: 'TEST CASE: Arrest incident test for form validation',
    arrest_reason: 'Immigration violation',
    arrest_charges: 'Unlawful entry',
    arrest_context: 'Arrested at workplace during raid',
  ...
  },
  {
    ...
    city: 'Denver',
    state: 'CO',
    facility: 'Test Immigration Facility',
    subject_age: 55,
    subject_gender: 'male',
    subject_nationality: 'Haiti',
    subject_immigration_status: 'undocumented',
    summary: 'TEST CASE: Medical neglect test for form validation',
    medical_condition: 'Diabetes requiring insulin',
    treatment_denied: 'Insulin was withheld for 48 hours',
...
async function createTestCases() {
  console.log('Creating test cases for all incident types...\n');
  ...
  console.log('\n--- Test Cases Summary ---');
  console.log('Created test cases for:');
